    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#captchaImage").click(function () {//点击更换验证码
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/img/createImage?time=" + new Date());
            });
...
<div class="login">
    <form id="loginForm" action="${pageContext.request.contextPath}/admin/loginAdmin" method="post">
        ...
        <table>
            <tbody>
            <tr>
                <td colspan="3" align="center"><span style="color:red">${param.message}</span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/img/createImage"
                         title="点击更换验证码"/>
                </td>
            </tr>
            <tr>
